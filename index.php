    ...
    if(isset($_POST['btn_login'])){
        ...
        if(is_array($row)){
            ...
            if($row['username']==$username AND $row['password']==$password AND $row['role']=="admin"){
                ...
                echo $notif = "<div class=\alert alert-success col-md-12\" style=\"max-width:24%; flex:unset\">Berasil Login </div>";
            ...
            echo $notif = "<div class=\"alert alert denger col-md-12\" style=\"max-widht:24%; flex:unset\">Username / Password Salah </div>";
        }
    }
        ...
        <div class="card-body">
            ...
            <form action="#" method="POST">
                ...
                <div class="row">
                    <!-- /.col -->
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary btn-block" name="btn_login">Masuk</button>
                    </div>
                    <!-- /.col -->
                </div>
            </form>
